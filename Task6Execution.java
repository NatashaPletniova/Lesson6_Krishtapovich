package by.epam.les6.task;

public class Task6Execution {
	...
	public static void main(String[] args) {
		...
		PoliticalJournalism journalism2 = new PoliticalJournalism("Ivanov", " The life of Putin", 2017, LiteraryWorkType.JOURNALISM, "article", "Putin");
		PoliticalJournalism journalism3 = new PoliticalJournalism("Lafare", "Trump's student life", 2017, LiteraryWorkType.JOURNALISM, "article", "Trump");
